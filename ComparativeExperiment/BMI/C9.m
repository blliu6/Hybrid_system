...
init = [0.25-((x1-(0.25))^2+(x2-(0.25))^2+(x3-(0.25))^2)];
unsafe = [0.25-((x1-(1.5))^2+(x2-(-1.5))^2+(x3-(-1.5))^2)];
inv = [-(x1 - (-2.0))*(x1-(2.0));-(x2 - (-2.0))*(x2-(2.0));-(x3 - (-2.0))*(x3-(2.0))];

f = [-x2; -x3; x1^3 - x1 - 2*x2 - x3];

[B, b, v] = polynomial([x1, x2, x3], 4);
par = [b];
